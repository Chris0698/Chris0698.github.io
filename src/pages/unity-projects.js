    ...
    return (
        <Layout>
          ...
          <p className="projectOverview">In my spare time I have worked with the Unity Game Engine and done two small projects. Both projects extended the basic tutorials to include other features
              such as extra game features and interactivity.
          </p>
          ...
          <div className="projectInfo">
              <div className="projectInfoCol1">
                  <p> My first project I extended a simple asteroid shooter game tutorial found  
                      <Link href="https://learn.unity.com/project/space-shooter-tutorial" target="_blank" rel="noopener noreferrer">here</Link>. For this game, I added an interactive game menu, another game mode 
          ...
          <div className="projectInfo">
              <div className="projectInfoCol1">
                <p>The second project I extended the survival shooter tutorial located 
                    <Link href="https://learn.unity.com/project/survival-shooter-tutorial" target="_blank" rel="noopener noreferrer">here</Link>. This time i added "boss" like enemies and multiple levels of 
