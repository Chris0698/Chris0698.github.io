      ...
      <div className="projectInfo">
        <div className="projectInfoCol1">
          ...
          <p>
            ...
            For extra practise i decided to save the balls drawn and what balls i selected (or got my a lucky dip) to a local SQL Server database 
            using Entity Framework using a code first approach, which is opposite of how the booking system database was implemented.
          </p>
          <p>
          ...
          <p>
            ...
            Elements from the dictionary was randomly selected, the amount selected dependant on the number of main balls selected (5 for Thunderball and 6 for Lotto).  
          ...
          <p>
            The database was a local SQL Server database that part of Visual Studio. This was a code first approach. For simplisitcaly i had 1 table called draws that stored an ID,
            the numbers drawn, the total cost, prize money won and the numbers selected for the draw. This made use of a draw class that contained the properties for each of these 
