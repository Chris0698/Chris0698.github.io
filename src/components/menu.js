...
//this $Props is stopping it being put into the .sass file
...
const Menu = () => {
  ...
  return(
    <div className="styledMenu">
      ...
      <StyledHamburgerButton className="styledHamburgerButton" onClick={toggleMenu} menuOpen={menuOpen} ref={buttonRef}>
